...
import logo from '../img-20231001T112429Z-001/img/logo.png'
import avatar from '../img-20231001T112429Z-001/img/avatar.png'
import {MdAddCircleOutline, MdLogout, MdAddShoppingCart , MdAdd } from "react-icons/md";
...
const Header = () => {
  ...
  return (
    <div className='fixed z-10 w-screen bg-yellow-200 p-6 px-16'>
      {/* desktop and tablet */}
      <div className='hidden md:flex w-full h-full items-center justify-between'>
      <Link to='/' className="flex items-center gap-2">
                    <img src={logo} className="w-8 object-cover" alt="logo" />
                    <p className="text-headingColor text-xl font-bold">Chicken Food</p>
                </Link>
